...
void JSONPushParserTests::OnDataObjectTest4(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[4].first, JSONPushParserTestCallbacks::EventType::memberElementBegin);
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[6].second, "name value");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[7].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[7].second, ASCII::LineEnding);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[8].first, JSONPushParserTestCallbacks::EventType::memberElementEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[9].first, JSONPushParserTestCallbacks::EventType::memberEnd);
...
void JSONPushParserTests::OnDataObjectTest5(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NOT(complete);
    ISHIKO_TEST_ABORT_IF_NEQ(callbacks.events().size(), 19);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[0].first, JSONPushParserTestCallbacks::EventType::objectBegin);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[1].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[1].second, std::string(ASCII::LineEnding) + "    ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[2].first, JSONPushParserTestCallbacks::EventType::memberBegin);
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[6].first, JSONPushParserTestCallbacks::EventType::stringValue);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[6].second, "name value");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[7].first, JSONPushParserTestCallbacks::EventType::memberElementEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[8].first, JSONPushParserTestCallbacks::EventType::memberEnd);
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[10].first, JSONPushParserTestCallbacks::EventType::memberBegin);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[11].first, JSONPushParserTestCallbacks::EventType::memberName);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[11].second, "name2");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[12].first, JSONPushParserTestCallbacks::EventType::memberElementBegin);
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[16].first, JSONPushParserTestCallbacks::EventType::memberElementEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[17].first, JSONPushParserTestCallbacks::EventType::memberEnd);
...
void JSONPushParserTests::OnDataObjectTest6(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NOT(complete);
    ISHIKO_TEST_ABORT_IF_NEQ(callbacks.events().size(), 27);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[0].first, JSONPushParserTestCallbacks::EventType::objectBegin);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[1].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[1].second, std::string(ASCII::LineEnding) + "    ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[2].first, JSONPushParserTestCallbacks::EventType::memberBegin);
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[14].first, JSONPushParserTestCallbacks::EventType::trueValue);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[14].second, "true");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[15].first, JSONPushParserTestCallbacks::EventType::memberElementEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[16].first, JSONPushParserTestCallbacks::EventType::memberEnd);
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[18].first, JSONPushParserTestCallbacks::EventType::memberBegin);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[19].first, JSONPushParserTestCallbacks::EventType::memberName);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[19].second, "name3");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[20].first, JSONPushParserTestCallbacks::EventType::memberElementBegin);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[21].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[21].second, " ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[22].first, JSONPushParserTestCallbacks::EventType::nullValue);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[22].second, "null");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[23].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[23].second, ASCII::LineEnding);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[24].first, JSONPushParserTestCallbacks::EventType::memberElementEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[25].first, JSONPushParserTestCallbacks::EventType::memberEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[26].first, JSONPushParserTestCallbacks::EventType::objectEnd);
    ISHIKO_TEST_PASS();
}
...
void JSONPushParserTests::OnDataNestedObjectsTest1(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[5].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[5].second, " ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[6].first, JSONPushParserTestCallbacks::EventType::objectBegin);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[7].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[7].second, std::string(ASCII::LineEnding) + "        ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[8].first, JSONPushParserTestCallbacks::EventType::memberBegin);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[9].first, JSONPushParserTestCallbacks::EventType::memberName);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[9].second, "nested object name");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[10].first, JSONPushParserTestCallbacks::EventType::memberElementBegin);
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[12].second, "nested object value");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[13].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[13].second, std::string(ASCII::LineEnding) + "    ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[14].first, JSONPushParserTestCallbacks::EventType::memberElementEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[15].first, JSONPushParserTestCallbacks::EventType::memberEnd);
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[18].first, JSONPushParserTestCallbacks::EventType::memberElementEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[19].first, JSONPushParserTestCallbacks::EventType::memberEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[20].first, JSONPushParserTestCallbacks::EventType::objectEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[21].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[21].second, ASCII::LineEnding);
    ISHIKO_TEST_PASS();
}
...
void JSONPushParserTests::OnDataNestedObjectsTest2(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NOT(complete);
    ISHIKO_TEST_ABORT_IF_NEQ(callbacks.events().size(), 32);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[0].first, JSONPushParserTestCallbacks::EventType::objectBegin);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[1].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[1].second, std::string(ASCII::LineEnding) + "    ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[2].first, JSONPushParserTestCallbacks::EventType::memberBegin);
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[15].second, "nested nested object name");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[16].first, JSONPushParserTestCallbacks::EventType::memberElementBegin);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[17].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[17].second, " ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[18].first, JSONPushParserTestCallbacks::EventType::stringValue);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[18].second, "nested nested object value");
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[20].first, JSONPushParserTestCallbacks::EventType::memberElementEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[21].first, JSONPushParserTestCallbacks::EventType::memberEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[22].first, JSONPushParserTestCallbacks::EventType::objectEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[23].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[23].second, std::string(ASCII::LineEnding) + "    ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[24].first, JSONPushParserTestCallbacks::EventType::memberElementEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[25].first, JSONPushParserTestCallbacks::EventType::memberEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[26].first, JSONPushParserTestCallbacks::EventType::objectEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[27].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[27].second, ASCII::LineEnding);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[28].first, JSONPushParserTestCallbacks::EventType::memberElementEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[29].first, JSONPushParserTestCallbacks::EventType::memberEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[30].first, JSONPushParserTestCallbacks::EventType::objectEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[31].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[31].second, ASCII::LineEnding);
    ISHIKO_TEST_PASS();
}
...
void JSONPushParserTests::OnDataComplexObjectTest1(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NOT(complete);
    ISHIKO_TEST_ABORT_IF_NEQ(callbacks.events().size(), 28);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[0].first, JSONPushParserTestCallbacks::EventType::objectBegin);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[1].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[1].second, std::string(ASCII::LineEnding) + "    ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[2].first, JSONPushParserTestCallbacks::EventType::memberBegin);
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[5].second, " ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[6].first, JSONPushParserTestCallbacks::EventType::stringValue);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[6].second, "name1 value");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[7].first, JSONPushParserTestCallbacks::EventType::memberElementEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[8].first, JSONPushParserTestCallbacks::EventType::memberEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[9].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[9].second, std::string(ASCII::LineEnding) + "    ");
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[13].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[13].second, " ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[14].first, JSONPushParserTestCallbacks::EventType::arrayBegin);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[15].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[15].second, " ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[16].first, JSONPushParserTestCallbacks::EventType::stringValue);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[16].second, "string");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[17].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[17].second, " ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[18].first, JSONPushParserTestCallbacks::EventType::trueValue);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[18].second, "true");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[19].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[19].second, " ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[20].first, JSONPushParserTestCallbacks::EventType::nullValue);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[20].second, "null");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[21].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[21].second, " ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[22].first, JSONPushParserTestCallbacks::EventType::arrayEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[23].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[23].second, std::string(ASCII::LineEnding));
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[24].first, JSONPushParserTestCallbacks::EventType::memberElementEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[25].first, JSONPushParserTestCallbacks::EventType::memberEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[26].first, JSONPushParserTestCallbacks::EventType::objectEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[27].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[27].second, std::string(ASCII::LineEnding));
    ISHIKO_TEST_PASS();
}
...
void JSONPushParserTests::OnDataComplexObjectTest2(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NOT(complete);
    ISHIKO_TEST_ABORT_IF_NEQ(callbacks.events().size(), 34);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[0].first, JSONPushParserTestCallbacks::EventType::objectBegin);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[1].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[1].second, std::string(ASCII::LineEnding) + "    ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[2].first, JSONPushParserTestCallbacks::EventType::memberBegin);
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[16].first, JSONPushParserTestCallbacks::EventType::objectBegin);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[17].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[17].second, std::string(ASCII::LineEnding) + "            ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[18].first, JSONPushParserTestCallbacks::EventType::memberBegin);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[19].first, JSONPushParserTestCallbacks::EventType::memberName);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[19].second, "nestedname1");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[20].first, JSONPushParserTestCallbacks::EventType::memberElementBegin);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[21].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[21].second, " ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[22].first, JSONPushParserTestCallbacks::EventType::stringValue);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[22].second, "nestedname1 value");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[23].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[23].second, std::string(ASCII::LineEnding) + "        ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[24].first, JSONPushParserTestCallbacks::EventType::memberElementEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[25].first, JSONPushParserTestCallbacks::EventType::memberEnd);
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[27].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[27].second, std::string(ASCII::LineEnding) + "    ");
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[28].first, JSONPushParserTestCallbacks::EventType::arrayEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[29].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[29].second, std::string(ASCII::LineEnding));
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[30].first, JSONPushParserTestCallbacks::EventType::memberElementEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[31].first, JSONPushParserTestCallbacks::EventType::memberEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[32].first, JSONPushParserTestCallbacks::EventType::objectEnd);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[33].first, JSONPushParserTestCallbacks::EventType::whitespace);
    ISHIKO_TEST_FAIL_IF_NEQ(callbacks.events()[33].second, std::string(ASCII::LineEnding));
    ISHIKO_TEST_PASS();
}
